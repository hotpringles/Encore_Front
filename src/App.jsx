  ...
  const reports = [
    {
      ...
      imageUrl:
        "https://imgnews.pstatic.net/image/005/2025/09/26/2025092522310480633_1758807064_1758791917_20250926002009351.jpg?type=w860",
      quiz: {
        ox: {
        ...
        mc: {
          id: "mc-1",
          question:
            "기사에서 언급된 원·달러 환율 상승의 주요 배경이 아닌 것은?",
          options: [
            "미 연준의 신중한 금리 인하 태도",
            "미 연방정부 셧다운 우려",
            "한국의 기준금리 인상",
          ...
          answer: "한국의 기준금리 인상",
          explanation:
            "기사에서는 달러 강세의 배경으로 미국 내 요인과 유럽의 리스크를 언급했지만, 한국의 기준금리 인상에 대해서는 언급하지 않았습니다.",
        },
      },
    },
    {
      ...
      imageUrl:
        "https://imgnews.pstatic.net/image/421/2025/09/26/0008511339_001_20250926160616644.jpg?type=w860",
      quiz: {
        ox: {
        ...
        mc: {
          id: "mc-2",
          question:
            "솔라나(SOL)의 반등 모멘텀으로 가장 중요하게 거론되는 이벤트는 무엇인가요?",
          options: [
            "새로운 디파이 프로젝트 출시",
            "솔라나 재단의 토큰 소각",
            "그레이스케일의 현물 ETF 승인 결정",
            "대규모 에어드랍 이벤트",
          ],
          answer: "그레이스케일의 현물 ETF 승인 결정",
          explanation:
            "기사에 따르면, 10월 10일로 예정된 그레이스케일의 솔라나 현물 ETF 승인 여부가 기관 자금 유입에 대한 기대로 중요한 반등 모멘텀으로 꼽히고 있습니다.",
        },
      },
    },
    {
      id: 3,
      title:
        "민주당 디지털자산TF, “외국인 투자·파생상품 허용”…경쟁력 회복 해법 제시",
      summary: `더불어민주당 
      ...
      imageUrl:
        "https://imgnews.pstatic.net/image/018/2025/09/25/0006125002_002_20250925190222034.jpg?type=w860",
      quiz: {
        ox: {
        ...
        mc: {
          id: "mc-3",
          question:
            "더불어민주당 디지털자산TF가 국내 산업 경쟁력 회복을 위해 제안한 정책이 아닌 것은?",
          options: [
            "외국인 투자 허용",
            "디지털자산 파생상품 도입",
            "원화 기반 스테이블코인 정책 마련",
          ...
          explanation:
            "TF는 외국인 투자 허용, 파생상품 도입, 스테이블코인 정책 마련 등을 촉구했으며, 거래세 즉시 도입은 논의된 내용이 아닙니다.",
        },
      },
    },
  ];
        ...
        <main className={"app-main grow"}>
          ...
          >
            ...
            <Routes>
              ...
              />
              <Route path="/main" element={<AppMain reports={reports} />} />
